...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'autocomplete.data';
      var REMOTE_PACKAGE_BASE = 'autocomplete.data';
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_autocomplete.data');

      };
      Module['addRunDependency']('datafile_autocomplete.data');
   ...
   loadPackage({"files": [{"filename": "/dictionary.mydb", "start": 0, "end": 306786, "audio": 0}], "remote_package_size": 306786, "package_uuid": "62a71b9e-2d72-40c1-9d68-0fd4000a7037"});
...
var wasmBinaryFile = 'autocomplete.wasm';
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "__sys_open": ___sys_open, "__sys_read": ___sys_read, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_close": _fd_close, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _api_predict_init_dictionary = Module["_api_predict_init_dictionary"] = createExportWrapper("api_predict_init_dictionary");

/** @type {function(...*):?} */
var _api_predict_has_word = Module["_api_predict_has_word"] = createExportWrapper("api_predict_has_word");

/** @type {function(...*):?} */
var _api_predict_word = Module["_api_predict_word"] = createExportWrapper("api_predict_word");

/** @type {function(...*):?} */
var _api_predict_get_words = Module["_api_predict_get_words"] = createExportWrapper("api_predict_get_words");
